...
public class BLinearLayout extends LinearLayout implements IRoundInterface, IShadowInterface, IBorderInterface,ISuperLayoutInterface {
    ...
    public BLinearLayout(Context context, AttributeSet attrs, int defStyle) {
