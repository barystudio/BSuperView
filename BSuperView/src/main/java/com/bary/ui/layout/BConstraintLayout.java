...
public class BConstraintLayout extends ConstraintLayout implements IRoundInterface, IShadowInterface, IBorderInterface,ISuperLayoutInterface {
    ...
    public BConstraintLayout(Context context) {
        this(context, null);
    }

    public BConstraintLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BConstraintLayout(Context context, AttributeSet attrs, int defStyle) {
