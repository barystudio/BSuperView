 ...
 * date on 2020/1/21.
 */
public class BorderLayoutBuilder extends BaseLayoutBuilder implements IBorderInterface {
    ...
    public BorderLayoutBuilder(View view, ISuperLayoutInterface parentInterface) {
