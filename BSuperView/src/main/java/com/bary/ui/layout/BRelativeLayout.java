...
public class BRelativeLayout extends RelativeLayout implements IRoundInterface, IShadowInterface, IBorderInterface,ISuperLayoutInterface {
    ...
    public BRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
